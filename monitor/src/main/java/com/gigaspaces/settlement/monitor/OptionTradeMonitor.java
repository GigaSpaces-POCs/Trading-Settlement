 ...
 */
public class OptionTradeMonitor implements InitializingBean, DisposableBean {

	private static Log LOG = LogFactory.getLog(OptionTradeMonitor.class);
	...
	private OptionTradeMonitorTask optionTradeMonitorTask;
	...
	public void afterPropertiesSet() throws Exception {
		...
		optionTradeMonitorTask = new OptionTradeMonitorTask();
		monitorThread = new Thread(optionTradeMonitorTask);
		monitorThread.start();
	}

	public class OptionTradeMonitorTask implements Runnable {
		...
		public void run() {
			try {
				...
				while (alive) {
					...
					LOG.info("Current number of option trades in space: " + tradescount);
