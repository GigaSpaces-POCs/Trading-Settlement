...
public class OptionTradeFeederJMXMonitor implements DynamicMBean ,InitializingBean,DisposableBean{
	...
	public void setTradeFeederService(OptionTradeFeederService optionTradeFeederService) {
	...
	public void setTradeFeederInterval(int milliseconds) throws Exception {
		optionTradeFeederService.setOptionTradeFeederInterval(milliseconds);
	}
	
	public void generateOptionTrades(int numberOfTrades) throws Exception {
		System.out.println("Generating Trades: " + numberOfTrades);
		optionTradeFeederService.generateOptionTrades(numberOfTrades);
	}
	...
	public void afterPropertiesSet() throws Exception {
		...
		tradeFeederMBeanName= new ObjectName(OptionTradeFeederJMXMonitor.class.getPackage().getName()+ ":type=TradeFeederJMXMonitor");
...
//		Method getObjectMethod = null;
		...
		try {
			generateTrades = OptionTradeFeederJMXMonitor.class.getMethod("generateOptionTrades", new Class[] {Integer.TYPE});
//			getObjectMethod = GigaSpacesClientCacheJMXAccessor.class.getMethod("getObject");
		...
		MBeanOperationInfo[] operators = new MBeanOperationInfo[] {new MBeanOperationInfo("Generate OptionTrades", generateTrades)};
